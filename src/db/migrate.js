...
,
  ...
  `CREATE INDEX IF NOT EXISTS idx_users_v2_org ON users_v2(org_id,status)`,
  `CREATE TABLE IF NOT EXISTS invitation_codes (
    ...
    expires_at TIMESTAMPTZ,
    used_by UUID REFERENCES users_v2(id) ON DELETE SET NULL,
    used_at TIMESTAMPTZ,
    created_by UUID REFERENCES users_v2(id) ON DELETE SET NULL,
    created_at TIMESTAMPTZ NOT NULL DEFAULT now()
  )`,
  `CREATE INDEX IF NOT EXISTS idx_invites_org_status ON invitation_codes(org_id,status,expires_at)`,
  ...
  `CREATE TABLE IF NOT EXISTS audit_logs_v2 (
    ...
    actor_user_id UUID REFERENCES users_v2(id) ON DELETE SET NULL,
    actor TEXT DEFAULT 'system',
    action TEXT NOT NULL,
    target TEXT,
    ip_address TEXT,
  ...
  `CREATE INDEX IF NOT EXISTS idx_audit_v2_org_time ON audit_logs_v2(org_id,created_at DESC)`
